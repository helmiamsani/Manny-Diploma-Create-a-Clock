...
{
    const float degreesPerHour = 30f, degreeesPerMinute = 6f, degreesPerSecond = 6f;
    ...
    void UpdateContinuous()
    {
        ...
        minutesTransform.localRotation = Quaternion.Euler(0f, (float)time.TotalMinutes * degreeesPerMinute, 0f);
    ...
    void UpdateDiscrete()
    {
        ...
        minutesTransform.localRotation = Quaternion.Euler(0f, time.Minute * degreeesPerMinute, 0f);
